  ...
  return (
    <nav
      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center gap-4 w-full">
        {/* <a
          href="#"
          className="inline-block min-w-9 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded">
        ...
        <div
          ...
          <div className="py-2 px-4 flex justify-between items-center border-b border-slate-300 sticky top-0 bg-white lg:hidden max-lg:min-h-[68px]">
            <a
              href="#"
              className="inline-block focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded">
              <span className="sr-only">Your Company</span>
              <img
                src="https://readymadeui.com/logo-alt.svg"
            ...
            <button
              ...
              onClick={closeMenu}
              id="toggleClose"
              className="btn cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded">
        ...
        <div className="flex items-center gap-4 ml-auto">
          ...
          <button
            ...
            id="toggleOpen"
            onClick={openMenu}
            className="cursor-pointer lg:hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded">
